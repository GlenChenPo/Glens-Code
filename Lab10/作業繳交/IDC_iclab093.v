...
reg clk_sleep_op1,clk_sleep_op2,clk_sleep_op3,clk_sleep_op4,clk_sleep_op5,clk_sleep_op6,clk_sleep_op7,clk_sleep_op8,clk_sleep_op9,clk_sleep_op10,clk_sleep_op11,clk_sleep_op12,clk_sleep_op13,clk_sleep_op14,clk_sleep_op15;
wire clk_op1,clk_op2,clk_op3,clk_op4,clk_op5,clk_op6,clk_op7,clk_op8,clk_op9,clk_op10,clk_op11,clk_op12,clk_op13,clk_op14,clk_op15;
//--- Gated OR --------------------------------------------------
GATED_OR GATED_OP1  (.CLOCK(clk),.SLEEP_CTRL(clk_sleep_op1 ),.RST_N(rst_n),.CLOCK_GATED(clk_op1 ));
GATED_OR GATED_OP2  (.CLOCK(clk),.SLEEP_CTRL(clk_sleep_op2 ),.RST_N(rst_n),.CLOCK_GATED(clk_op2 ));
GATED_OR GATED_OP3  (.CLOCK(clk),.SLEEP_CTRL(clk_sleep_op3 ),.RST_N(rst_n),.CLOCK_GATED(clk_op3 ));
GATED_OR GATED_OP4  (.CLOCK(clk),.SLEEP_CTRL(clk_sleep_op4 ),.RST_N(rst_n),.CLOCK_GATED(clk_op4 ));
GATED_OR GATED_OP5  (.CLOCK(clk),.SLEEP_CTRL(clk_sleep_op5 ),.RST_N(rst_n),.CLOCK_GATED(clk_op5 ));
GATED_OR GATED_OP6  (.CLOCK(clk),.SLEEP_CTRL(clk_sleep_op6 ),.RST_N(rst_n),.CLOCK_GATED(clk_op6 ));
GATED_OR GATED_OP7  (.CLOCK(clk),.SLEEP_CTRL(clk_sleep_op7 ),.RST_N(rst_n),.CLOCK_GATED(clk_op7 ));
GATED_OR GATED_OP8  (.CLOCK(clk),.SLEEP_CTRL(clk_sleep_op8 ),.RST_N(rst_n),.CLOCK_GATED(clk_op8 ));
GATED_OR GATED_OP9  (.CLOCK(clk),.SLEEP_CTRL(clk_sleep_op9 ),.RST_N(rst_n),.CLOCK_GATED(clk_op9 ));
GATED_OR GATED_OP10 (.CLOCK(clk),.SLEEP_CTRL(clk_sleep_op10),.RST_N(rst_n),.CLOCK_GATED(clk_op10));
GATED_OR GATED_OP11 (.CLOCK(clk),.SLEEP_CTRL(clk_sleep_op11),.RST_N(rst_n),.CLOCK_GATED(clk_op11));
GATED_OR GATED_OP12 (.CLOCK(clk),.SLEEP_CTRL(clk_sleep_op12),.RST_N(rst_n),.CLOCK_GATED(clk_op12));
GATED_OR GATED_OP13 (.CLOCK(clk),.SLEEP_CTRL(clk_sleep_op13),.RST_N(rst_n),.CLOCK_GATED(clk_op13));
GATED_OR GATED_OP14 (.CLOCK(clk),.SLEEP_CTRL(clk_sleep_op14),.RST_N(rst_n),.CLOCK_GATED(clk_op14));
GATED_OR GATED_OP15 (.CLOCK(clk),.SLEEP_CTRL(clk_sleep_op15),.RST_N(rst_n),.CLOCK_GATED(clk_op15));

//---------MAP--------------------------------------------------------------------------------------------
reg clk_sleep_map1;
wire clk_map1;
GATED_OR GATED_MAP1 (.CLOCK(clk),.SLEEP_CTRL(clk_sleep_map1),.RST_N(rst_n),.CLOCK_GATED(clk_map1));
...
always @(posedge clk_map1 or negedge rst_n)
begin
    if (!rst_n)
    begin
        for ( j=0 ;j<=7;j=j+1 )
...
//    Operation
//==============================================================
always @(posedge clk_op1 or negedge rst_n)
begin
    if(!rst_n)
        operation[0] <= 0;
...
always @(posedge clk_op2 or negedge rst_n)
begin
    if(!rst_n)
        operation[1] <= 0;
...
always @(posedge clk_op3 or negedge rst_n)
begin
    if(!rst_n)
        operation[2] <= 0;
...
always @(posedge clk_op4 or negedge rst_n)
begin
    if(!rst_n)
        operation[3] <= 0;
...
always @(posedge clk_op5 or negedge rst_n)
begin
    if(!rst_n)
        operation[4] <= 0;
...
always @(posedge clk_op6 or negedge rst_n)
begin
    if(!rst_n)
        operation[5] <= 0;
...
always @(posedge clk_op7 or negedge rst_n)
begin
    if(!rst_n)
        operation[6] <= 0;
...
always @(posedge clk_op8 or negedge rst_n)
begin
    if(!rst_n)
        operation[7] <= 0;
...
always @(posedge clk_op9 or negedge rst_n)
begin
    if(!rst_n)
        operation[8] <= 0;
...
always @(posedge clk_op10 or negedge rst_n)
begin
    if(!rst_n)
        operation[9] <= 0;
...
always @(posedge clk_op11 or negedge rst_n)
begin
    if(!rst_n)
        operation[10] <= 0;
...
always @(posedge clk_op12 or negedge rst_n)
begin
    if(!rst_n)
        operation[11] <= 0;
...
always @(posedge clk_op13 or negedge rst_n)
begin
    if(!rst_n)
        operation[12] <= 0;
...
always @(posedge clk_op14 or negedge rst_n)
begin
    if(!rst_n)
        operation[13] <= 0;
...
always @(posedge clk_op15 or negedge rst_n)
begin
    if(!rst_n)
        operation[14] <= 0;
...
//---------------------------------------------------------------
// Combinatial Circuit for gated or
//---------------------------------------------------------------
always @(*)
begin
    if(!cg_en)
